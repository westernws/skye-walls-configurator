			...
			<main className="Main space-y-20">
				<section className="flex justify-center mb-10">
					<div className="w-12/12 md:w-7/12 mt-6">
						<h1 className={classNames(headingStyles.Heading, headingStyles['Heading--ruled'], 'md:text-5xl')}>Design Your Door</h1>
				...
				<section className="space-y-20">
					<div className="space-y-12">
						<h2 className={`${headingStyles.Heading} ${headingStyles['Heading--bordered']}`}>
							<span className={headingStyles['Heading-rule']} />
							Sliding
							<span className={headingStyles['Heading-rule']} />
						</h2>
