...
const ConfigProduct = ({ snapshot = null, doNotApplySnapshot = false }) => {
	if (!isEmpty(snapshot)) {
		console.log('snapshot exists');
		console.log('doNotApplySnapshot', doNotApplySnapshot);
		if (!doNotApplySnapshot) {
...
export const getServerSideProps = async (context) => {
	...
	if (context.req.method === 'POST') {
		...
		// console.log('BEGIN POST SNAP');
		// console.log(snapshot);
		// console.log('END POST SNAP');
		// applySnapshot(appStore, JSON.parse(snapshot));
		// appStore.setConfigPage(context.query.product);
		// doNotApplySnapshot = true;
	}
